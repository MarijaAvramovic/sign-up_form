...
Making a a sign-up form for an imaginary service.
Apply skills for fonts, forms, absolute positioning (advsnced html and css).

The design has a large background-image that can be found on unsplash.com, thanks to Halie West. 
